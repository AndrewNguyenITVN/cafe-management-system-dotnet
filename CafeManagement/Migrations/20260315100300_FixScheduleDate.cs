...
{
    /// <inheritdoc />
    public partial class FixScheduleDate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_JobPositions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeQuantity = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreId = table.Column<int>(type: "int", nullable: false),
                    IngredientId = table.Column<int>(type: "int", nullable: false),
                    CurrentQuantity = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalAmount = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyRateAtTime = table.Column<decimal>(type: "decimal(12,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timekeepings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Timekeepings_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountTendered = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
                    ChangeAmount = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLogs_StoreId_CreatedAt",
                table: "InventoryLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timekeepings_StoreId",
                table: "Timekeepings",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_Timekeepings_UserId_Date",
                table: "Timekeepings",
